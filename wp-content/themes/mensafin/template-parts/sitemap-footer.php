<?php
 /*
  * Sitemap footer. Used by most pages.
  *
  * @package mensafin
  */
?>
  ...
  <footer>
    <div id="footerInfoArea"> 
       ...
       <div style="width:195px;" class="footerInfo">
         <ul>
           <li style="padding-bottom:5px;" class="footerText">YHTEYSTIEDOT</li>
       ...
       <div class="footerInfo">
         <ul>
           ...
           <li></li>
           <li style="padding-bottom:5px;" class="footerText"> Viimeisin p&auml;ivitys 7.10.2013</li>
